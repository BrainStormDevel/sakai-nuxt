...
// Function to safely get saved preferences from localStorage
const getSavedConfig = () => {
    ...
    if (typeof window !== 'undefined' && typeof localStorage !== 'undefined') {
        try {
            ...
            console.warn('Error parsing layout config from localStorage:', e);
            return {};
        }
    }
    return {};
...
const layoutConfig = reactive({
    ...
    theme: savedConfig.theme || 'lara-light-blue'
});
...
// Watch for changes and save to localStorage (only in browser)
if (typeof window !== 'undefined' && typeof localStorage !== 'undefined') {
    watch(
        () => layoutConfig,
        (newConfig) => {
            try {
                ...
                console.warn('Error saving layout config to localStorage:', e);
            }
        },
        { deep: true }
    );
...
export function useLayout() {
    const primaryColors = [
        ...
        { name: 'pink', palette: { 50: '#fdf2f8', 100: '#fce7f3', 200: '#fbcfe8', 300: '#f9a8d4', 400: '#fb7185', 500: '#f43f5e', 600: '#e11d48', 700: '#be123c', 800: '#9f1239', 900: '#881337', 950: '#500724' } },
    ...
    const surfaces = [
        ...
        {
            name: 'gray',
            palette: { 0: '#ffffff', 50: '#f9fafb', 100: '#f3f4f6', 200: '#e5e7eb', 300: '#d1d5db', 400: '#a3a3af', 500: '#6b7280', 600: '#4b5563', 700: '#374151', 800: '#1f2937', 900: '#111827', 950: '#030712' }
        },
        {
            name: 'zinc',
    ...
    const setPrimary = (value) => {
        ...
        // Update the theme with the new primary color
        if (typeof window !== 'undefined') {
            const presetExt = getPresetExt(primaryColors, value);
    ...
    const setSurface = (value) => {
        ...
        // Update the theme with the new surface color
        if (typeof window !== 'undefined') {
            const surface = surfaces.find((s) => s.name === value);
            if (surface) {
